...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"微信点餐小程序","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* WEBPACK VAR INJECTION */(function(wx) {App({
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
// 云开发 API 封装
var callCloudFunction = function callCloudFunction(name, action) {
...
var _default = {
  ...
  dishes: {
    ...
    getAll: function getAll() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var includeInactive, res;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                includeInactive = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : false;
                _context.next = 3;
                return callCloudFunction('dish', 'getAll', {
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return callCloudFunction('dish', 'getById', {
                  id: id
                });
              case 2:
                res = _context2.sent;
        ...
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return callCloudFunction('dish', 'create', data);
              case 2:
        ...
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return callCloudFunction('dish', 'update', _objectSpread({
                  id: id
                }, data));
              case 2:
        ...
        return _regenerator.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return callCloudFunction('dish', 'delete', {
                  id: id
                });
              case 2:
    ...
    // 获取横幅图片
    getBanners: function getBanners(fileList) {
        ...
        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return callCloudFunction('dish', 'getBanners', {
                  fileList: fileList
                });
              case 2:
                res = _context6.sent;
  ...
  orders: {
        ...
        return _regenerator.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return callCloudFunction('order', 'getAll', {
                  userId: userId
                });
              case 2:
                res = _context7.sent;
                return _context7.abrupt("return", {
                  success: true,
                  data: res.data.map(function (order) {
        ...
        return _regenerator.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return callCloudFunction('order', 'getById', {
                  id: id
                });
              case 2:
                res = _context8.sent;
    ...
    // 微信支付统一下单
    unifiedOrder: function unifiedOrder(orderId, totalPrice, openid) {
        ...
        return _regenerator.default.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _context10.next = 2;
                return callCloudFunction('order', 'unifiedOrder', {
                  orderId: orderId,
        ...
        return _regenerator.default.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _context11.next = 2;
                return callCloudFunction('order', 'updateStatus', {
                  id: id,
                  status: status
                });
              case 2:
        ...
        return _regenerator.default.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                _context12.next = 2;
                return callCloudFunction('order', 'delete', {
                  id: id
                });
              case 2:
        ...
        return _regenerator.default.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                _context14.next = 2;
                return callCloudFunction('user', 'wechatLogin', {
                  code: code
                });
              case 2:
        ...
        return _regenerator.default.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                _context15.next = 2;
                return callCloudFunction('user', 'updateProfile', _objectSpread({
                  id: id
                }, data));
              case 2:
        ...
        return _regenerator.default.wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                _context17.next = 2;
                return callCloudFunction('user', 'getInfo', {
                  id: id
                });
              case 2:
